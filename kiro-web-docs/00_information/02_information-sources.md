...
| **5** | フィード（Atom） | **補助のみ** | **直近25件中 7 件が Web**（2026-09-13 実測）。**系列別フィードは 404**。25件のウィンドウしか無く**取りこぼす**（[詳細](01_official-site-structure.md#フィードは-kiro-web-を配信対象にしています2026-09-13-実測)） |
