...
| ファイル | 内容 |
|---------|------|
| [01_official-site-structure.md](01_official-site-structure.md) | **公式サイトの構造マップ**。`changelog/web/` の系列構造・docs の Web 区分（15ページ）・sitemap と `llms.txt` の違い・URL の作法・移転した5ページの記録 |
...
|----------------|---------------|--------------|
| **Web** | `/docs/web/`（15ページ） | **本サイトの対象** |
| IDE | `/docs/`（188ページ） | 姉妹サイト [kiro-ide-docs](https://github.com/kamogashira-sys/kiro-ide-docs) |
| CLI | `/docs/cli/`（35ページ） | 姉妹サイト [q-cli-docs](https://github.com/kamogashira-sys/q-cli-docs) |
